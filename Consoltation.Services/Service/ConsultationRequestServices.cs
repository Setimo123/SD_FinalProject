    ...
    public class ConsultationRequestServices : IConsultationRequestServices
    {
        ...
        public async Task<List<ConsultationRequest>> GetStudentPendingList(string studentUMID, Status status)
        {
          ...
          public async Task AddConsultation(string subjectcode, string subjectname,
            ...
            {
                await _repository.AddConsultation(subjectcode, subjectname, starttime, endtime, studentID,
                facultyID, programname, concern, dateSchedule);
            }

        public async Task<List<Program>> GetProgram()
        {
             return await _repository.GetProgram();
        }
